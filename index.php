<div class="ortadiv">
    ...
    <?php
    session_start();
    $list = new PDO("mysql:host=localhost;dbname=mertmaki_gunlukizler", 'root', '191919Hmz'); // bağlantı kodu
    $listele = $list->query("SELECT * FROM post_yonetimi ORDER BY post_id DESC");
    ...
    echo "<div class='postkategori'>#" . $row['kategoriler'] . "</div>";
